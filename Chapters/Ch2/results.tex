...
Figure 2 shows the learned weights from the N\&M dataset for both the articulatory and phonological-features theories.
...
\begin{figure*}[t]
\makebox[\textwidth][c]{\includegraphics[width=\textwidth]{Figures/Ch2/Slide4.PNG}}
